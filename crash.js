...
var config = {
  ...
  baseBet: { label: 'Starting Bet:', value: 2, type: 'number' },
  maxBet: { label: 'Maximum Bet:', value: 1000, type: 'number' },
  ...
  maxPayout: { label: 'Maximum Payout:', value: 20, type: 'number' },
  minPayout: { label: 'Minimum Payout:', value: 1.3, type: 'number' },
  ...
  mulBetLoss: { label: 'Multiply Bet By:', value: 4, type: 'number' },
